...
public class CompoundMessageFormatting {
    static void displayStockInfo(Locale requestedLocale) {                  // (1)
        ...
        System.out.println("Local area: " + requestedLocale.getDisplayCountry());

        // Fetch the relevant resource bundle:                                   (2)
        ResourceBundle bundle =
                ResourceBundle.getBundle("StockInfoBundle", requestedLocale);
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        displayStockInfo(new Locale("ro", "MD"));
        System.out.println();
    }
}