...
public class TaskExecutor {
    ...
    public static void main(String[] args) {
        ...
        out.println("1.Priority queue using natural ordering (task number).");
        PriorityQueue<Task> pq1 = new PriorityQueue<>();                        // (2)
        testPQ(taskArray, pq1);

        out.println("2.Priority queue using reverse natural ordering.");          // (3)
        PriorityQueue<Task> pq2 = new PriorityQueue<>(Comparator.reverseOrder());
        testPQ(taskArray, pq2);

        out.println("3.Priority queue using reversed ordering"
        ...
        out.println("5. Priority queue using total ordering based on task number,"
        ...
        out.println("6. Priority queue using total ordering based on task number,"
