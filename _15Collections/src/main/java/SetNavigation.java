...
//        out.println(strSetA.subSet("a", false, "z", false )); // [ballroom, dancing]
        ...
        out.println("\nClosest-matches:");               // (4)
        out.println("ceiling : " + strSetA.ceiling("ball"));            // ballroom
        out.println("floor : " + strSetA.floor("ball"));              // Strictly
        out.println("higher : " + strSetA.higher("ballroom"));         // dancing
        out.println("lower : " + strSetA.lower("ballroom"));          // Strictly
