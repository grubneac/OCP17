class TLClass {                                            // (1)  TLC
    ...
    class InnerB {                                           // (5)  NSMC
        ...
        static void printStatic(){
            System.out.println("jhdsgfjhsdgfj");
        }
        ...
        class InnerC {                                         // (11) NSMC
            ...
            public void printId() {                              // (14)
                System.out.print(TLClass.InnerB.this.id + " : ");         // (15) Refers to (2)
...
public class OuterInstances {                                // (22)
    public static void main(String[] args) {                   // (23)
        ...
        TLClass.InnerB.printStatic();
        TLClass.InnerB b = a.new InnerB("b");                    // (25) b  --> a
        TLClass.InnerB.InnerC c1 = b.new InnerC("c1");           // (26) c1 --> b
        TLClass.InnerB.InnerC c2 = new TLClass("a").new InnerB("b").new InnerC("c2");           // (27) c2 --> b
        b.printId();                                             // (28)
        c1.printId();                                            // (29)
        c2.printId();                                            // (30)
        System.out.println("------------");
